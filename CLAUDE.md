...
1. `~/.claude/projects/press-portal/memory/MEMORY.md`
   → Routing index. Tells you which files to read next.

2. `~/.claude/projects/press-portal/memory/active-work.md`
   → What other agents are doing RIGHT NOW. Avoid their files.

3. `~/.claude/projects/press-portal/memory/projects/press-portal.md`
